...
const formCadDocente = document.getElementById("formCadDocente") as HTMLFormElement;
const txtNome = document.getElementById("txtNome") as HTMLInputElement;
const txtTitulacao = document.getElementById("txtTitulacao") as HTMLInputElement;
const flsFoto = document.getElementById("flsFoto") as HTMLInputElement;
// MUDANÇA: O ID no HTML foi ajustado para 'divMensagemCadDocente'
const divMensagemCadDocente = document.getElementById("divMensagemCadDocente") as HTMLDivElement;
const btnSubmit = document.getElementById("btnSubmit") as HTMLButtonElement;
const imgFotoAtual = document.getElementById("imgFotoAtual") as HTMLImageElement; // Novo elemento
const tituloFotoAtual = document.getElementById("tituloFotoAtual") as HTMLHeadingElement;
 ...
 */
function processarDocente(nome: string, titulacao: string, fotoBase64: string): void {
    if (!id) {
        // CADASTRO
...
function carregarDadosDocente(id: string) {
